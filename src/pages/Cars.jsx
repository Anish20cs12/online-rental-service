    ...
    <div className="py-8">
      <div className="max-w-6xl mx-auto px-4">
        <motion.h2
          ...
          className="text-2xl font-semibold mb-6 bg-gradient-to-r from-indigo-600 to-blue-500 bg-clip-text text-transparent heading-glow"
        >
          Cars
        </motion.h2>
